...
class DrivingConstants:
    ...
    # CORAL LOCATIONS
    CORAL_LOCATIONS = {
        "REEF_A": (2.861, 4.200, 0),  # (X, Y, HEADING (ROTATION))
        "REEF_B": (2.890, 3.864, 0),  # (X, Y, HEADING (ROTATION))
        "REEF_C": (3.528, 2.737, 60),  # (X, Y, HEADING (ROTATION))
        "REEF_D": (3.840, 2.554, 60),  # (X, Y, HEADING (ROTATION))
        "REEF_E": (5.125, 2.552, 120),  # (X, Y, HEADING (ROTATION))
        "REEF_F": (5.424, 2.717, 120),  # (X, Y, HEADING (ROTATION))
        "REEF_G": (6.078, 3.857, 180),  # (X, Y, HEADING (ROTATION))
        "REEF_H": (6.092, 4.198, 180),  # (X, Y, HEADING (ROTATION))
        "REEF_I": (5.413, 5.342, -120),  # (X, Y, HEADING (ROTATION))
        "REEF_J": (5.148, 5.492, -120),  # (X, Y, HEADING (ROTATION))
        "REEF_K": (3.824, 5.495, -60),  # (X, Y, HEADING (ROTATION))
        "REEF_L": (3.555, 5.332, -60),  # (X, Y, HEADING (ROTATION))
